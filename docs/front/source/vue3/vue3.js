var Vue = (function (exports) {
  ...
  function createReactiveObject(
    ...
    // 在全局weakMap数据类型的 reactiveMap中找对应对象是否已经被做过响应式，做过直接返回
  ...
  class RefImpl {
    ...
    set value(newVal) {
      ...
      if (hasChanged(newVal, this._rawValue)) {
        ...
        // 将新值再做一次响应式代理，解决 newVal是对象的情况时，里面的数据没响应式
